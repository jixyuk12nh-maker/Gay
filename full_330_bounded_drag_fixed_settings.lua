...
do
    local base = UIBase.new():setLabel("Minho Hub") do
        ...
        do
            ...
            do
                ...
                menu:newSlider("settings/menu/text_size", 16, 26, 1):set(16):setLabel("Text Size")
    ...
    -- Apply Settings changes live and persist them.
    local function applyMenuSettings()
        ...
        local accent = accentFeature and accentFeature.value and accentFeature.value.rgb
        local textSize = sizeFeature and tonumber(sizeFeature.value) or 16

        if not base.instances.gui then return end
        for _, obj in ipairs(base.instances.gui:GetDescendants()) do
            if obj:IsA("TextLabel") or obj:IsA("TextButton") or obj:IsA("TextBox") then
                obj.TextSize = textSize
            end
            if accent then
                if obj:IsA("Frame") and obj.BackgroundColor3 == Color3.fromRGB(55, 175, 225) then
                    obj.BackgroundColor3 = accent
                elseif obj:IsA("TextLabel") or obj:IsA("TextButton") then
                    if obj.TextColor3 == Color3.fromRGB(55, 175, 225) then
                        obj.TextColor3 = accent
                    end
                elseif obj:IsA("ScrollingFrame") and obj.ScrollBarImageColor3 == Color3.fromRGB(55, 175, 225) then
