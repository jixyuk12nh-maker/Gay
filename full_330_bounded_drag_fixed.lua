...
do
    local base = UIBase.new():setLabel("Minho Hub|V1") do
        ...
        do
            ...
            skin:newDropdown("skins/skin/select", false, {
                "Skin 1",
                "Skin 2",
                "Skin 3"
            })
            ...
            wrap:newDropdown("skins/wrap/select", false, {
                "Wrap 1",
                "Wrap 2",
                "Wrap 3"
            })
            ...
            charm:newDropdown("skins/charm/select", false, {
                "Charm 1",
                "Charm 2",
                "Charm 3"
            })
            ...
            finisher:newDropdown("skins/finisher/select", false, {
                "Finisher 1",
                "Finisher 2",
                "Finisher 3"
            })
        ...
        do
            ...
            menu:newLabel("Keybind"):setLabel("Keybind")
                :newKeybind("settings/menu_keybind", { "Tap" })
                :set({ key = Enum.KeyCode.RightShift, mode = "Tap" })
