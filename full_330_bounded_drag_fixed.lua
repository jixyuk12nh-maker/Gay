...
do
    local base = UIBase.new():setLabel("Minho Hub") do
        ...
        do
            ...
            local skin = skins:newSection("left", "Skin")
            do
                skin:newToggle("skins/skin/enabled"):setLabel("Enable Skin")
                skin:newLabel("skins/skin/label_selected"):setLabel("Selected Skin")
                skin:newDropdown("skins/skin/selected", false, {"Default"}):set("Default")
            end

            local wrap = skins:newSection("right", "Wrap")
            do
                wrap:newToggle("skins/wrap/enabled"):setLabel("Enable Wrap")
                wrap:newLabel("skins/wrap/label_selected"):setLabel("Selected Wrap")
                wrap:newDropdown("skins/wrap/selected", false, {"Default"}):set("Default")
            end

            local charm = skins:newSection("left", "Charm")
            do
                charm:newToggle("skins/charm/enabled"):setLabel("Enable Charm")
                charm:newLabel("skins/charm/label_selected"):setLabel("Selected Charm")
                charm:newDropdown("skins/charm/selected", false, {"Default"}):set("Default")
            end

            local finisher = skins:newSection("right", "Finisher")
            do
                finisher:newToggle("skins/finisher/enabled"):setLabel("Enable Finisher")
                finisher:newLabel("skins/finisher/label_selected"):setLabel("Selected Finisher")
                finisher:newDropdown("skins/finisher/selected", false, {"Default"}):set("Default")
            end
        end
