...
do
    local base = UIBase.new():setLabel("Minho Hub") do
        ...
        if autoLoadToggle then
            autoLoadToggle.changed:Connect(function(value)
                if value then loadConfig((autoLoadSelect and autoLoadSelect.value) or "default.json") end
            end)
        end
        ...
        if readfile and isfile and isfile(configPath("default")) then
            loadConfig("default")
        end
